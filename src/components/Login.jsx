		...
		<div className="flex flex-col items-center justify-center min-h-screen bg-[#F1F0EE]">
			...
			<div className="bg-white backdrop-blur-lg p-8 rounded-lg shadow-lg w-full max-w-sm sm:w-4/5 md:w-1/2 lg:w-1/3 border border-white/30 ">
				...
				<form onSubmit={handleLogin}>
					...
					<button
						type="submit"
						className="w-full p-2 bg-green-500 text-white rounded mt-4 hover:bg-blue-700"
					>
						Log in
					</button>
				</form>
				<div className="flex justify-between items-center mt-5">
					...
					<Link to="/Signup">
						<button className="border border-blue-500 text-blue-600 py-2 px-4 rounded hover:bg-blue-500 hover:text-white">
							Sign Up
						</button>
					</Link>
				</div>
