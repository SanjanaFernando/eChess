	...
	return (
		<section className="mb-8">
			<div className="flex flex-row mb-12">
				<div className="flex flex-col md:w-6/10 justify-center items-start py-32 mx-10">
					...
					<div className="flex flex-wrap justify-center gap-5 mb-10">
						<div className="w-full sm:w-auto flex-1 py-5 bg-white/20 text-left">
							<img
								src="/box.gif"
								alt="Box GIF"
								className="mb-4 h-16 w-16"
							/>
							<h2 className="text-2xl mb-2 text-black font-semibold">Online Play</h2>
						...
						<div className="w-full sm:w-auto flex-1 py-5 bg-white/20 text-left">
							<img
								...
								className="mb-4 h-16 w-16"
							/>
							<h2 className="text-2xl mb-2 text-black font-semibold">
			...
			<div className="mb-28">
				...
				<div className="flex flex-wrap justify-center gap-5 mb-10">
					<div className="flex-1 min-w-[250px] max-w-[350px] p-5">
						<img
							src="/box.gif"
							alt="Box GIF"
