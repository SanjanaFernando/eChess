			...
			<section className="mt-8 bg-white p-6 sm:p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
				...
				<form onSubmit={handleSubmit}>
					...
					<p className="text-sm text-gray-500 mb-6 text-center">
						After successful completion of payment, you will receive
						an SMS from "ECHESS" and an email from
						"payment-report@payu.lk" as proof of confirmation,
						mentioning the Payment ID, without which the entry is
						not confirmed.
					</p>
